                ...
                <div className="lg:col-span-8 space-y-16">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-7 gap-4">
                            <>
                                <div className="col-span-1 text-[#000] mt-2 font-bold">{t("days")}</div>
                                <div className="col-span-4 text-[#000] mt-2 font-bold">{t("highlight")}</div>
                                <div className="col-span-2 text-[#000] mt-2 font-bold">{t("overnight")}</div>
                            </>
                            {tourDetail?.exclusion?.split(/\n+/).map((line, lineIdx) => {
                    ...
                    <section>
                        ...
                        <div className="space-y-8">
                            {tourDetail?.itineraryDays?.map((item, i) => (
                                <motion.div
                                    key={i}
                                    className="flex flex-col md:flex-row gap-5 bg-white rounded-2xl shadow-sm overflow-hidden">
                                    <div className="md:w-1/3 h-48 md:h-auto overflow-hidden">
                                        <img
                                            ...
                                            onClick={() =>
                                                openLightbox(
                                                    tourDetail?.itineraryDays?.map((d) => d.imageUrl),
                                                    i,
                                                )
                                            }
                                        />
