...
const SearchTour = () => {
    ...
    const combineTour = searchParams.get("combineTour");
    ...
    const [filterSearch, setFilterSearch] = useState({
        ...
        combineTour: searchParams.get("combineTour"),
        page: 1,
        limit: 8,
    });
    ...
    const tourFake = [
        {
            ...
            meta_description: "Discover the highlight Vietnam from Hanoi to HCM City with memorable experiences",
    ...
    useEffect(() => {
        ...
        if (data) {
            setAllTours((prev) => (filterSearch?.page === 1 ? data : [...prev, ...data]));
        }
    }, [data, duration, side, location, style, combineTour, filterSearch.page]);
    ...
    return (
        <div className="min-h-screen bg-[#fcf5ef] px-6 py-10">
            ...
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
                <h1 className="text-4xl md:text-5xl font-bold text-gray-800">{t(title)}</h1>
            </motion.div>
        ...
        `}>
                ...
                "
                                ...
                                <div className="flex-1 p-5 flex flex-col justify-between">
                                    <div>
                                        ...
                                        <p className="text-gray-500 mt-2 line-clamp-3">{tour?.meta_description}</p>
                                    </div>
                                    <div className="flex items-center justify-start mt-4">
                                        <span className="text-sm text-gray-600">⏱ {tour?.duration_days}</span>
                                    </div>
            ...
            <div className="flex justify-center mt-10">
                <button
                    ...
                    className="px-4 py-2 bg-[#e38c2b] text-white rounded-xl hover:bg-black transition cursor-pointer">
