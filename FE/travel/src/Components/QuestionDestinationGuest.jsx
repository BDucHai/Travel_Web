...
import { createQuestion, createQuestionReply, getQuestions } from "../api/Question";
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 mb-1">
                                        <span className="font-semibold md:text-[1.1rem]">{q?.name}</span>
                                    ...
                                    {/* QUESTION CONTENT */}
                                    <p className="text-[#000] leading-6">{q?.content}</p>
                                        ...
                                        <div className="mt-4 ml-1 pl-4 border-l-2 border-[#dce7e3] space-y-3">
                                            {q.replies.map((r) => (
                                                <div
                                                    ...
                                                    <p className=" leading-6">{r?.content}</p>
                                                </div>
                                            ))}
                                        </div>
                                    )}
                                    ...
                                    <div className="flex justify-end mt-3">
                                        <Button
                                            variant="text"
                                            size="medium"
                                            onClick={() => setActiveReply((prev) => (prev === q.id ? null : q.id))}
                                            sx={{
                                                textTransform: "none",
                                                color: "#557a75",
                                                fontSize: "0.85rem",
                                            ...
                                            {activeReply === q.id ? t("cancel") : t("reply")}
                                        </Button>
                                    </div>
                                    ...
                                    {activeReply === q.id && (
                                        <div className="mt-2 ml-1 pl-4 border-l-2 border-dashed border-[#dce7e3]">
                                            <div className="bg-[#f8faf9] rounded-lg p-4 border border-[#e5ece9]">
                                                {/* Form title */}
                                                <div className="mb-3">
                                                    <div className="font-semibold">{t("reply")}</div>
